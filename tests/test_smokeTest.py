...
class TestSmokeTest():
  ...
  def test_verifyAdminLoginwithIncorrectCredentials(self):
  ...
  def test_verifyBusinessDisplayinGridandListViews(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1552, 832)
    self.driver.find_element(By.LINK_TEXT, "Directory").click()
    self.driver.find_element(By.ID, "directory-grid").click()
    self.driver.execute_script("window.scrollTo(0,910.4000244140625)")
    assert self.driver.find_element(By.CSS_SELECTOR, ".gold-member:nth-child(9) > p:nth-child(2)").text == "Teton Turf and Tree"
    self.driver.find_element(By.ID, "directory-list").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".gold-member:nth-child(9) > p:nth-child(2)").text == "Teton Turf and Tree"
  
  def test_verifyHomePageElementsLogoHeadingandTitle(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
  ...
  def test_verifyJoinPageFormNavigationandInputs(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/join.html")
    elements = self.driver.find_elements(By.NAME, "fname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").click()
    self.driver.find_element(By.NAME, "fname").send_keys("daphne")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Museruka")
    self.driver.find_element(By.NAME, "submit").click()
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Avritech")
    self.driver.find_element(By.NAME, "submit").click()
  ...
  def test_verifyNavigationandJoinUsLinkFunctionality(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
